...
class SiameseNet2(SiameseNet):
    def __init__(self, w_dropout_1, w_dropout_2):

        super(SiameseNet2, self).__init__(w_dropout_1, w_dropout_2, 3)

        self.model_name = 'SiameseNet2'

        self.fb = nn.Sequential(
            nn.Conv2d(1024, 3, kernel_size=3, stride=1, padding=0),
    ...
    def forward(self, inp):
        ...
        # feedback from IT
        p_cat = torch.cat((vIT_p1, vIT_p2), 1)
        fb = self.fb(p_cat)
